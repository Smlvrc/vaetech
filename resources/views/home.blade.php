...
{{--        </div>--}}
        ...
        <!--? collection -->
        <section class="collection section-bg2 section-padding30 section-over1 ml-15 mr-15" data-background="{{asset('storage/'.$about->image)}}">
            <div class="container-fluid"></div>
            <div class="row justify-content-center">
                <div class="col-xl-7 col-lg-9">
                    <div class="single-question text-center">
                        <h2 class="wow fadeInUp" data-wow-duration="2s" data-wow-delay=".1s">{!! $about->title !!}</h2>
                        <span>{!! $about->text !!}</span>
                        <br>
                        <a href="about.html" class="btn class="wow fadeInUp" data-wow-duration="2s" data-wow-delay=".4s">Click me</a>
                    </div>
                </div>
            </div>
            </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="single-product mb-50">
                            <div class="location-img">
                                <img src="{{asset('storage/'.$about2->image)}}" alt="">
                            </div>
                            <div class="location-details">
                                <p><a href="{{route('page.detail', $about2->slug)}}">{!! $about2->title !!}<br>{!! $about2->text !!} </a></p>
                                <a href="{{route('page.detail', $about2->slug)}}" class="btn">Read More</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="single-product mb-50">
                            <div class="location-img">
                                <img src="{{asset('storage/'.$about3->image)}}" alt="">
                            </div>
                            <div class="location-details">
                                <p><a href="{{route('page.detail', $about3->slug)}}">{!! $about3->title !!}<br> {!! $about3->text !!}</a></p>
                                <a href="{{route('page.detail', $about3->slug)}}" class="btn">Read More</a>
                            </div>
                        </div>
                    </div>
                </div>
